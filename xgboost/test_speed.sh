...
xgboost/xgboost xgboost.conf tree_method=exact data="../data/year.train" objective="reg:linear" 2>&1 | tee xgboost_year_speed.log
...
xgboost/xgboost xgboost.conf max_bin=255 tree_method=hist grow_policy=lossguide max_depth=0 max_leaves=255 data="../data/year.train" objective="reg:linear" 2>&1 | tee xgboost_hist_year_speed.log
